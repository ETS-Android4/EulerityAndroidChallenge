...
public class FileSaveHelper implements LifecycleObserver {
    ...
    private String getFilePath(Uri editedImageUri) {
        String[] proj = {MediaStore.Images.Media.DATA};
        Cursor cursor = mContentResolver.query(editedImageUri, proj, null, null, null);
        int column_index = cursor.getColumnIndexOrThrow(MediaStore.Images.Media.DATA);
        cursor.moveToFirst();
        String output = cursor.getString(column_index);
        cursor.close();
        return output;
    }
